...
function getAllBriefs(storeId: string): BriefInput[] {
  return [
    ...
    // 7.9 — Bundles
    {
      ...
      category: "Product Deep Dives",
      platform: "Reel / TikTok",
      hook: "You have a course, a preset pack, and a sample pack. Separately they're $120. As a bundle they're $79. The savings math does itself.",
    ...
    // 2.1 — What Producers Actually Pay
    {
      ...
      cta: "Link in bio to see full pricing breakdown",

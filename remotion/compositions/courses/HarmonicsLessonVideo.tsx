...
// ═══════════════════════════════════════════════════════════════════════
// HARMONICS LESSON: "Invisible 808s"
...
const Scene1_Hook: React.FC = () => {
  ...
  return (
    <CenterScene opacity={op} translateY={y} tint={C.darkGray} seed={100}>
...
const Scene2_Problem: React.FC = () => {
  ...
  return (
    <CenterScene opacity={op} translateY={y} tint={C.red} seed={101}>
      <FadeUp delay={5}>
...
const Scene3_Solution: React.FC = () => {
  ...
  return (
    <CenterScene opacity={op} translateY={y} tint={C.orange} seed={102}>
      <FadeUp delay={10}>
...
// ─── SCENE 4: PROOF (20-28s) — Audible Everywhere ──────────────────────
const Scene4_Proof: React.FC = () => {
  ...
  return (
    <CenterScene opacity={op} translateY={y} tint={C.green} seed={103}>
      <FadeUp delay={5}>
...
// ─── SCENE 5: CTA (28-35s) — Learn Sound Design ────────────────────────
const Scene5_CTA: React.FC = () => {
  return (
    <CenterScene tint={C.orange} seed={104}>

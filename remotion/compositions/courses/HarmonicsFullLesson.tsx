...
// ═══════════════════════════════════════════════════════════════════════
// HARMONICS LESSON (FULL): "Invisible 808s - Masterclass"
...
const Scene1_Hook: React.FC = () => {
  ...
  return (
    <CenterScene opacity={op} translateY={y} tint={C.darkGray} seed={120}>
...
const Scene2_Problem: React.FC = () => {
  ...
  return (
    <CenterScene opacity={op} translateY={y} tint={C.red} seed={121}>
      <FadeUp delay={5}>
...
const Scene3_Solution: React.FC = () => {
  ...
  return (
    <CenterScene opacity={op} translateY={y} tint={C.orange} seed={122}>
      <FadeUp delay={10}>
...
const Scene3_Tools: React.FC = () => {
  ...
  return (
    <CenterScene opacity={op} translateY={y} tint={C.purple} seed={123}>
      <FadeUp delay={5}>
...
// ─── SCENE 3.8: PRO TIP (28-36s) — Keep Fundamental ────────────────────
const Scene3_ProTip: React.FC = () => {
  const { op, y } = useExit(220, 240);
  const frame = useCurrentFrame();
  
  return (
    <CenterScene opacity={op} translateY={y} tint={C.cyan} seed={124}>
      <FadeUp delay={5}>
        <SectionLabel color={C.cyan}>PRO TIP</SectionLabel>
      </FadeUp>

      <div style={{ fontSize: 36, fontWeight: 700, color: C.white, fontFamily: F, textAlign: "center", marginTop: 20, lineHeight: 1.4 }}>
        Keep the
        <br />
        <span style={{ color: C.cyan, fontWeight: 900 }}>Fundamental Clean.</span>
      </div>
      
      <div style={{ fontSize: 20, color: C.gray, fontFamily: F, marginTop: 20 }}>
        Only saturate 200Hz+
      </div>
    </CenterScene>
  );
...
// ─── SCENE 4: PROOF (36-44s) — Audible Everywhere ──────────────────────
const Scene4_Proof: React.FC = () => {
  ...
  return (
    <CenterScene opacity={op} translateY={y} tint={C.green} seed={125}>
      <FadeUp delay={5}>
...
// ─── SCENE 5: CTA (44-55s) — Learn Sound Design ────────────────────────
const Scene5_CTA: React.FC = () => {
  return (
    <CenterScene tint={C.orange} seed={126}>

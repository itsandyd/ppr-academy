...
const PLATFORMS: Record<string, PlatformConfig> = {
  ...
  soundcloud: {
    ...
    embedTemplate:
      "https://w.soundcloud.com/player/?url={url}&auto_play=false&hide_related=true&show_comments=false&show_user=true&show_reposts=false&show_teaser=false&visual=true",
  },
  youtube: {
    name: "YouTube",
...
export async function extractMetadataFromUrl(url: string): Promise<MusicTrackMetadata> {
  ...
  const metadata: MusicTrackMetadata = {
    ...
    platform: platform as MusicTrackMetadata["platform"],
    originalUrl: url,
    embedUrl,
  };
 ...
 */
async function extractSoundCloudMetadata(
  url: string,
  base: MusicTrackMetadata
 ...
 */
async function extractSpotifyMetadata(
  url: string,
  base: MusicTrackMetadata
): Promise<MusicTrackMetadata> {
 ...
 */
async function extractGenericMetadata(
  url: string,
  base: MusicTrackMetadata
): Promise<MusicTrackMetadata> {
  try {

...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  try {
    ...
    const structuredData = {
      ...
      "applicationSubCategory": "AudioPlugin",
      "offers": {
        "@type": "Offer",
      ...
      ...(plugin.author && { "author": { "@type": "Organization", "name": plugin.author } }),
      ...(plugin.description && { "description": stripHtml(plugin.description).substring(0, 200) }),

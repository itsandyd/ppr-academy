...
import { Coffee, Image as ImageIcon, Loader2 } from "lucide-react";
...
export function TipJarBasicsForm() {
    ...
    <Card className="p-6">
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold">Tip Jar Details</h2>
            <p className="text-sm text-muted-foreground">Let fans support your work</p>
          </div>
        </div>

...
export function CheatSheetBasicsForm() {
    ...
    <Card className="p-6">
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold">Cheat Sheet Details</h2>
            <p className="text-sm text-muted-foreground">Create a quick reference guide</p>
          </div>
        </div>
        ...
        <ValidatedField
          ...
          placeholder="e.g., Music Theory Cheat Sheet, Mixing EQ Guide"
          description="What will your cheat sheet cover?"
        />
        ...
        <div className="space-y-2">
          <ValidatedField
            ...
            placeholder="Describe what's included in your cheat sheet - key topics, tips, and what makes it valuable..."
            rows={4}
            maxLength={500}
            showCharCount
          />

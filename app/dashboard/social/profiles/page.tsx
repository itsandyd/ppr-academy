...
import { AccountProfilesList } from "@/components/social-media/account-profiles/AccountProfilesList";
  ...
  if (!storeId) {
    return (
      <div className="p-4 md:p-6 space-y-6">
        <div>
          <h1 className="text-xl md:text-3xl font-bold mb-2">Account Profiles</h1>
          <p className="text-muted-foreground">
            Organize your content for different social media pages
          </p>
        </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-muted-foreground mb-4">
                  Account profiles require a creator store. Set up your store to
  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-xl md:text-3xl font-bold">Account Profiles</h1>
          <p className="text-muted-foreground">
            Organize your content for different social media pages
          </p>
        </div>
      ...
      <AccountProfilesList storeId={storeId} userId={effectiveUserId!} />
    </div>
  );
}

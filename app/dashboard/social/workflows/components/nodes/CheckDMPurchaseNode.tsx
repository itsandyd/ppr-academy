...
function CheckDMPurchaseNode({ data, selected }: NodeProps) {
  const productName = data.productName || data.courseName;
...
export default memo(CheckDMPurchaseNode);

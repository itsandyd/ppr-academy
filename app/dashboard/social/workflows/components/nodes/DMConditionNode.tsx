...
function DMConditionNode({ data, selected }: NodeProps) {
  const label = conditionLabels[data.conditionType] || "DM Condition";
  ...
  return (
    ...
    >
      ...
      {data.conditionType === "contains_keyword" && data.keywords?.length > 0 && (
...
export default memo(DMConditionNode);

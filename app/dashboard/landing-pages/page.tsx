    ...
    return (
      <div className="p-4 md:p-6 space-y-6">
        ...
        <EmptyState
          ...
          description="Build custom landing pages to promote your beats, sample packs, and courses. Create your store to get started."
        ...
        <CardContent>
          {landingPages && landingPages.length > 0 ? (
            ...
            <div className="flex min-h-[200px] items-center justify-center">
              <EmptyState
                icon={Layout}
                title="Build a page that sells"
                description="Create focused landing pages for your beats, sample packs, and courses. Drive traffic from social media and convert visitors into buyers."
                action={{ label: "Create Landing Page", onClick: () => setIsCreateOpen(true) }}
              />
            </div>
          )}
        </CardContent>

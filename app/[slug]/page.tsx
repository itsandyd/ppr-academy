...
// Sidebar social button component - shows icon only when no label, icon + label when label provided
                  ...
                  <div className="border-t border-border pt-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {store.socialLinksV2 && store.socialLinksV2.length > 0 ? (
                        ...
                        <>
                          {store.socialLinks?.instagram && (
                            <SidebarSocialButton href={store.socialLinks.instagram} platform="instagram" />
                          )}
                          {store.socialLinks?.youtube && (
                            <SidebarSocialButton href={store.socialLinks.youtube} platform="youtube" />
                          )}
                          {store.socialLinks?.spotify && (
                            <SidebarSocialButton href={store.socialLinks.spotify} platform="spotify" />
                          )}
                        </>
                      )}
                    </div>

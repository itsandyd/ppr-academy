...
import { CreatorProfileViewTracker } from "./CreatorProfileViewTracker";
...
export interface StorefrontContentProps {
  slug: string;
  store: any;
  user: any;
  products: any[] | null;
  courses: any[] | null;
  storeStats: any | null;
  coachProfiles: any[] | null;
  bundles: any[] | null;
  membershipTiers: any[] | null;
}
...
export function StorefrontContent({
  ...
  return (
    <StorefrontLayout>
      ...
      <CreatorProfileViewTracker userId={store.userId} storeId={store._id} />
                ...
                <div className="border-t border-border pt-4">
                  ...
                  {store.genreTags && store.genreTags.length > 0 && (
                    <div className="flex flex-wrap gap-1 mt-2">
                      {store.genreTags.map((tag: string) => (
                        <span
                          key={tag}
                ...
                ((store.socialLinksV2 && store.socialLinksV2.length > 0) ||
                  ...
                  <div className="border-t border-border pt-4">
                    ...
                    <div className="flex flex-col gap-2">
                      {store.socialLinksV2 && store.socialLinksV2.length > 0 ? (
                        store.socialLinksV2.map((link: any, index: number) => (
                          <SidebarSocialLink

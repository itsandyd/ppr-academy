...
export default function AutomationBuilderPage({ params }: AutomationPageProps) {
  ...
  if (automation === null) {
    return (
      <Card className="p-12 text-center">
        ...
        <Button onClick={() => router.push(`/store/${storeId}/social`)}>
    ...
    <div className="space-y-6 max-w-5xl">
      ...
      <div className="flex items-center gap-4">
        <Button
          variant="ghost"
          size="sm"
          onClick={() => router.push(`/store/${storeId}/social`)}
          className="gap-2"
        >
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <Button
                          ...
                          onClick={() => router.push(`/store/${storeId}/settings/billing`)}
                        >
